...
draw_roundrect_ext(Tx+Twidth-300-string_width(textbox[? "name"]),Ty,Tx+Twidth-240,Ty-64,global.text_roundingname,global.text_roundingname,false);
draw_set_color(textbox[? "color_nameplate"]);
draw_text(Tx+Twidth-300-string_width(textbox[? "name"])+10,Ty-54,textbox[? "name"]);
draw_set_alpha(1);
